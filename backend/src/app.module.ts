...
// REMOVE: import { MailerService } from './infra/mail/mailer.service';
...
@Module({
  imports: [
    HttpModule, // This now contains MailerService
    DatabaseModule, 
    AuthModule
  ],
  controllers: [
  ...
  providers: [
    EmailService, 
    SmsService, 
    // REMOVE: MailerService, // Not needed here anymore
    SendBulkNotifications
  ],
  // REMOVE: exports: [MailerService] // Not needed
})
